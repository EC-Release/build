...
def main():
    ...
    os.system("CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=cgo GOARCH=amd64 go build -tags netgo -a -v -race -o /{}_linux_sys {}/*.go".format(BINARY,DHOME))
    
    os.system("CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=go GOARCH=amd64 go build -tags netgo -a -v -race -o /{}_linux_var {}/*.go".format(BINARY,DHOME))
    ...
    os.system('CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=cgo GOARCH=amd64 go build -ldflags "{}" -tags netgo -a -v -race -o /{}_linux_sys {}/*.go'.format(TLSLDFLAGS,TLSPLUGINBIN,TLSSRC))
    os.system('CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=cgo GOARCH=amd64 go build -ldflags "{}" -tags netgo -a -v -race -o /{}_linux_sys {}/*.go'.format(VLNLDFLAGS,VLNPLUGINBIN,VLNSRC))
    ...
    os.system('CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=go GOARCH=amd64 go build -ldflags "{}" -tags netgo -a -v -race -o /{}_linux_var {}/*.go'.format(TLSLDFLAGS,TLSPLUGINBIN,TLSSRC))
    os.system('CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=go GOARCH=amd64 go build -ldflags "{}" -tags netgo -a -v -race -o /{}_linux_var {}/*.go'.format(VLNLDFLAGS,VLNPLUGINBIN,VLNSRC))
