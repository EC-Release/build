...
def main():
    ...
    print "CMD-> CGO_ENABLED=0 GOOS=linux GODEBUG=netdns=cgo GOARCH=amd64 go build -ldflags '{}' -tags netgo -a -v -o /{}_linux_sys {}/*.go".format(TLSLDFLAGS,TLSPLUGINBIN,TLSSRC)
